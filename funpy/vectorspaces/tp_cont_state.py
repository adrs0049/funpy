...
class TwoParContState(BaseState):
    ...
    def __init__(self, p1=None, p2=None, u=None, *args, **kwargs):
    ...
    @property
    def shape(self):
        return (self.funcs[0].shape[0], self.funcs[0].shape[1])
