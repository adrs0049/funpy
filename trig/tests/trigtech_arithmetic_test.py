...
class TestTrigTech:
    def test_addition(self):
        fun1 = trigtech(op=lambda x: np.ones_like(x), type='trig')
        fun2 = trigtech(op=lambda x: np.ones_like(x), type='trig')
        fun3 = fun1 + fun2
    ...
    def test_addition_functions(self):
        fun1 = trigtech(op=lambda x: np.sin(2 * np.pi * x), type='trig')
        fun2 = trigtech(op=lambda x: np.cos(2 * np.pi * x), type='trig')
        fun3 = fun1 + fun2
    ...
    def test_addition_functions2(self):
        fun1 = trigtech(op=lambda x: np.sin(4 * np.pi * x), type='trig')
        fun2 = trigtech(op=lambda x: np.cos(6 * np.pi * x), type='trig')
        fun3 = fun1 + fun2

        xs = np.linspace(-1, 1, 1000)
        assert_almost_equal(fun3(xs), np.sin(4 * np.pi * xs) + np.cos(6 * np.pi * xs))
    ...
    def test_sub(self):
        fun1 = trigtech(op=lambda x: 2 * np.ones_like(x), type='trig')
        fun2 = trigtech(op=lambda x: np.ones_like(x), type='trig')
        fun3 = fun1 - fun2
    ...
    def test_mul(self):
        fun1 = trigtech(op=lambda x: 2*np.ones_like(x), type='trig')
        fun2 = trigtech(op=lambda x: 2*np.ones_like(x), type='trig')
        fun3 = fun1 * fun2
    ...
    def test_div(self):
        fun1 = trigtech(op=lambda x: 4*np.ones_like(x), type='trig')
        fun2 = trigtech(op=lambda x: 2*np.ones_like(x), type='trig')
        fun3 = fun1 / fun2
    ...
    def test_pow2(self):
        fun1 = trigtech(op=lambda x: np.cos(2 * np.pi * x), type='trig')
        fun2 = fun1**2
        xs = np.linspace(-1, 1, 1000)
